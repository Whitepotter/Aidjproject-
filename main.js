...
function draw(){
    ...
    if (rightWristscore > 0.2){
        ...
        if (song_2_status == "false"){
            song_2.play();
            document.getElementById("song_name").innerHTML = "Song Name - The Middle by Zedd,Grey and Maren Morris";
        }
    }
...
function gotPoses(results){
    if (results.length > 0){
        ...
        console.log("right wrist score is "+rightWristscore + " left wrist score is "+leftWristscore);
